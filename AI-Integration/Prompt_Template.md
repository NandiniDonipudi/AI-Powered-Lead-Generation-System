...
## Setup Steps
1. Enable Agentforce/Einstein GPT for the org (Setup → Einstein Setup)
2. Setup → Prompt Builder → New Prompt Template → Field Generation
3. Select Lead as the object, `AI_Summary__c` as the target field
4. Add the input fields listed above as merge fields in the prompt
5. Write and test the prompt instructions in the Prompt Builder preview panel
6. Activate the template
7. Reference the template from the Record-Triggered Flow (see `../Automation/Lead_Scoring_Flow.md`)

...
2. Create each field above with the specified type and picklist values
3. Set field-level security so both Sales Rep and Sales Manager profiles can read/edit as appropriate
4. Add fields to the Lead page layout under a new "AI Insights" section
5. Setup → Object Manager → Lead → Validation Rules → New → build `Reject_Personal_Email`
